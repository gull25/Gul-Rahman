...
const BLOG_POSTS = [
  {
    ...
    excerpt:  'The dependency array is the most misunderstood part of useEffect. We break down exactly how it works, when effects re-run, stale closures, and how the new useEffectEvent hook solves the trickiest edge cases.',
    content:  '# Understanding useEffect Dependencies\n\nFull content goes here...',
    category: 'React',
  ...
  },
  {
    ...
    excerpt:  'Both are powerful layout tools but choosing the wrong one leads to messy code. This guide breaks down the mental model for each.',
  ...
  },
  {
    ...
    excerpt:  'useMemo, useCallback, lazy loading, and code splitting — every React performance tool explained with clear examples.',
  ...
  },
  {
    ...
    excerpt:  'A step-by-step guide to building a scalable design system — component architecture, variant APIs, accessibility, and Storybook.',
  ...
  },
  {
    ...
    excerpt:  'Everything about React Router v6 — nested routes, outlet, dynamic params, protected routes, and programmatic navigation.',
  ...
  },
  {
    ...
    excerpt:  'Clean code in React is more than formatting — composition, custom hooks, naming conventions, and patterns that separate good code from great.',
