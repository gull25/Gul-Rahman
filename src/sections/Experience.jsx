...
function TimelineItem({ item, index, visible }) {
  ...
  return (
    ...
    >
      {/* Dot on the timeline */}
      <div className={`exp__dot ${item.current ? 'exp__dot--current' : ''} ${
      ...
      >
        ...
        <div className="exp__card-top">
          ...
          {/* Right — chevron */}
          <div className={`exp__chevron ${expanded ? 'exp__chevron--open' : ''}`}>
        ...
        {/* Expandable content */}
        <div className={`exp__card-body ${expanded ? 'exp__card-body--open' : ''}`}>
          ...
          <div className="exp__sidebar">
            ...
            <div className="exp__filters">
              ...
              {[
                ...
                { key: 'work',      label: 'Work',      count: EXPERIENCES.filter(e => e.type === 'work').length },
            ...
            <div className="exp__sidebar-skills">
              ...
              <div className="exp__sidebar-tags">
                {['React', 'TypeScript', 'Next.js', 'Redux',
                  'REST API', 'Figma', 'Jest', 'Git'].map(tag => (
                  <span key={tag} className="exp__sidebar-tag">{tag}</span>
                ))}
              </div>
            </div>
