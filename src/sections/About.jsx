...
const CHIPS = [
  ...
  'REST APIs', 'Accessibility',
  'Redux', 'Node.js',
]

const INFO = [
  { label: 'Location',    value: 'Lahore, Pakistan',    highlight: false },
  { label: 'Experience',  value: '3+ Years',            highlight: false },
  { label: 'Availability',value: 'Open to work',        highlight: true  },
  { label: 'Education',   value: 'BS Computer Science', highlight: false },
        ...
        <div className="about__grid">
          ...
          <div className="about__left">
            ...
            <div className="about__avatar-box">
              ...
              {/* Name + role */}
              <div className="about__avatar-name">Alex Johnson</div>
              ...
              <div className="about__socials">
                <a href="https://github.com"   target="_blank" rel="noopener noreferrer"
                  className="about__social" aria-label="GitHub">
                ...
                <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer"
                  className="about__social" aria-label="LinkedIn">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" strokeWidth="1.8">
                ...
                <a href="https://twitter.com"  target="_blank" rel="noopener noreferrer"
                  className="about__social" aria-label="Twitter">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" strokeWidth="1.8">
                ...
                <a href="mailto:alex@example.com"
                  className="about__social" aria-label="Email">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" strokeWidth="1.8">
