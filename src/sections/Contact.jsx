...
const IconPhone = () => (
  ...
  >
    <path
      d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0
...
function CustomSelect({ value, onChange, options, placeholder }) {
  ...
  return (
    <div className="contact__select-wrap" ref={ref}>
      <button
        type="button"
        className={`contact__select-trigger ${open ? "contact__select-trigger--open" : ""} ${value ? "contact__select-trigger--filled" : ""}`}
      ...
      >
        ...
        <span
          className={`contact__select-chevron ${open ? "contact__select-chevron--open" : ""}`}
        >
          <IconChevronDown />
        </span>
      </button>
        ...
        <div className="contact__select-dropdown">
          {options.map((opt) => (
            <button
              key={opt}
              type="button"
              className={`contact__select-option ${value === opt ? "contact__select-option--active" : ""}`}
              onClick={() => {
                onChange(opt);
                setOpen(false);
              }}
...
function FaqItem({ question, answer }) {
  ...
  return (
    <div
      className={`contact__faq-item ${open ? "contact__faq-item--open" : ""}`}
    >
      <button className="contact__faq-trigger" onClick={() => setOpen(!open)}>
        <span>{question}</span>
        <span
          className={`contact__faq-icon ${open ? "contact__faq-icon--open" : ""}`}
        >
          <IconChevronDown />
        </span>
      </button>
      <div
        className={`contact__faq-body ${open ? "contact__faq-body--open" : ""}`}
      >
          ...
          <div className="contact__info-panel">
            ...
            <div className="contact__tagline">
              ...
              <p className="contact__tagline-sub">
                Whether it's a full project, a quick question, or just wanting
                to connect — my inbox is always open. I typically respond within
                24 hours.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  answer:
                    "I typically respond to all messages within 24 hours on business days. For urgent matters, feel free to mark your message as urgent.",
                },
                {
                  question: "Do you work remotely?",
                  answer:
                    "Yes, I work fully remotely and am comfortable with async communication across different time zones.",
                },
                {
                  question: "What type of projects do you take?",
                  answer:
                    "I specialise in React and frontend work — from landing pages to complex dashboards and web applications.",
                },
              ].map((faq) => (
                <FaqItem
                  key={faq.question}
            ...
            {submitted ? (
              ...
              <div className="contact__success">
                ...
                <p className="contact__success-sub">
                  Thank you, {form.firstName}! I've received your message and
                ...
                <div className="contact__success-details">
                  <div className="contact__success-row">
                    ...
                    <span className="contact__success-row-value">
                      {form.subject}
                    </span>
                  </div>
                  {form.budget && (
              ...
              >
                <div className="contact__form-header">
                  ...
                  <p className="contact__form-sub">
                    Fields marked with{" "}
                    <span className="contact__required">*</span> are required.
                  </p>
                </div>
                ...
                <FormField label="Message" error={errors.message} required>
                  <div className="contact__textarea-wrap">
                    ...
                    <div className="contact__char-count">
                      <div
                        className="contact__char-track"
                        title={`${msgLength} / ${msgMax} characters`}
                      >
                        <div
                      ...
                      <span
                        className={`contact__char-num ${msgPercent > 90 ? "contact__char-num--warn" : ""}`}
                      >
                        {msgLength}/{msgMax}
                      </span>
                    </div>
                ...
                {/* Agreement checkbox */}
                <div
                  className={`contact__agree ${errors.agree ? "contact__agree--error" : ""}`}
                >
                  <label className="contact__agree-label">
                    ...
                    <span className="contact__agree-text">
                      I agree that my data will be used to respond to my
                      inquiry. No spam, ever.
                    </span>
                  </label>
                  {errors.agree && (
                    <span className="contact__field-error">{errors.agree}</span>
                  )}
                </div>
