        ...
        <div className="proj__featured-top">
          ...
          <div className="proj__links">
            <a href={project.code} target="_blank"
              rel="noopener noreferrer"
              className="proj__icon-link" title="View Code">
              <IconGithub />
            </a>
            <a href={project.demo} target="_blank"
              rel="noopener noreferrer"
              className="proj__icon-link" title="Live Demo">
              <IconExternalLink />
            </a>
          </div>
        </div>
        ...
        <div className="proj__inner">
          ...
          <div className="proj__header">
            ...
            <p className="proj__subtitle">
              A collection of projects I have built — from side experiments
          ...
          {regularProjects.length > 3 && (
            <div className="proj__show-more">
              ...
              >
                ...
                <span className={`proj__show-more-icon
          ...
          {filtered.length === 0 && (
            <div className="proj__empty">
              <div className="proj__empty-icon"><IconFolder /></div>
          ...
          <div className="proj__github-cta">
            <div className="proj__github-cta-inner">
              ...
              <div>
                <div className="proj__github-cta-title">
                  See more on GitHub
                </div>
